...
def load_gt_roidb(dataset_name, image_set_name, root_path, dataset_path,fold,result_path=None,
                  flip=False):
    """ load ground truth roidb """
    imdb = eval(dataset_name)(image_set_name, root_path, dataset_path,fold,result_path)
    roidb = imdb.gt_roidb()
    if flip:
